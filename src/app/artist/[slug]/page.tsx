...
export default async function ArtistPage({ params }: ArtistPageProps) {
  ...
  const popularTracks = getPopularTracksByArtistId(artist.id);
  const artistReleases = getReleasesByArtistId(artist.id).sort(
    (a, b) => +new Date(b.releaseDate) - +new Date(a.releaseDate),
  );
  const appearances = getAppearancesByArtistId(artist.id);
